<template>
    <section class="w-full flex flex-col bg-[url('/images/recruit/index/009.png')]">
        ...
        <div class="mb-4 w-full flex-1 flex justify-center items-center">
            <div class="md:ml-20 flex flex-col h-full">
                <img class="mt-4 object-cover w-[260px]" :src="images[index]" alt="社員紹介" />
                <div class="p-2 bg-gray-100 border border-custom-lightGray border-t-0 text-sm md:text-base" v-html="imagesDiscription[index]"></div>
                <div class="mt-4 flex-1 flex h-full items-end justify-center space-x-8 text-4xl font-bold text-custom-deepBlue">
