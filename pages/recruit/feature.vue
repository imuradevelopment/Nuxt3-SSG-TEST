    ...
    <div>
        ...
        <section>
            <div class="my-12 px-4 sm:mx-0 grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-3 sm:grid-flow-col sm:gap-x-4">
                ...
                <div class="order-3 mb-4 sm:mb-0 col-span-1 sm:row-span-2">
                    <BlurGlassCard class="p-4 text-xs sm:text-base font-bold sm:leading-7 leading-7">
                        「売上目標・利益目標を設けない」事により、利益度外視で成長に繋がる仕事を選ぶ事が出来ます。<br />
                        「組織を細分化しない」事により、様々な業務・技術・役割に挑戦する事が出来ます。<br />
                        「年功序列としない」事により、年齢や経験ではなく、やってみたい！と言う気持ちを大切にします。<br />
                        上記全て、やりたい事が出来ている時期というものが、人が一番成長出来る時期だと考えています。
                    </BlurGlassCard>
                </div>
            </div>
        </section>
        ...
        <!-- <section>
            <div class="mt-12 px-4 sm:mx-0 grid grid-cols-1 sm:grid-cols-2 sm:gap-x-4">
                ...
                <div class="order-2 mb-4 sm:mb-0 col-span-1 row-span-1">
                    <div class="p-4 bg-gray-200 text-xs sm:text-base font-bold">
